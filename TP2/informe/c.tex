...
\If{tipo C}{
\textbf{return} tamaño de la componente de v - 1\;
}
}
...
Y por último el pseudocódigo para calcular las componentes conexas del grafo 
sin puentes. 
