...
\hline
Homero se puede comer todas las rosquillas & \lstinputlisting{../src/casos/apuTodo.in} & \lstinputlisting{../src/casos/apuTodo.out} \\ \hline
Homero no puede comer ninguna rosquilla & \lstinputlisting{../src/casos/apuNada.in} & \lstinputlisting{../src/casos/apuNada.out} \\ \hline
Homero se puede comer una sola & \lstinputlisting{../src/casos/apuUna.in} & \lstinputlisting{../src/casos/apuUna.out} \\ \hline
Homero se puede comprar muchos paquetes de rosquillas & \lstinputlisting[linewidth=4cm,breaklines,breakindent=0em]{../src/casos/apuGrande.in} & El programa termina en menos de 1 segundo. \\ \hline
Homero se puede comer muchas rosquillas & \texttt{apuOverflow.in} & \lstinputlisting{../src/casos/apuOverflow.out} \\
\hline
\end{tabulary}
\end{flushleft}
