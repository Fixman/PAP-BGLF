...
Homero no puede comer ninguna rosquilla & \lstinputlisting{../src/casos/apuNada.in} & \lstinputlisting{../src/casos/apuNada.out} \\
Homero se puede comer una sola & \lstinputlisting{../src/casos/apuUna.in} & \lstinputlisting{../src/casos/apuUna.out} \\
Homero se puede comprar muchos paquetes de rosquillas & \lstinputlisting[linewidth=4cm,breaklines,breakindent=0em]{../src/casos/apuGrande.in} & El programa termina en menos de 1 segundo. \\
